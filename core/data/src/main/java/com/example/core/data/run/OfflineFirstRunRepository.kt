...
class OfflineFirstRunRepository(
    ...
    override suspend fun deleteRun(id: RunId) {
        ...
        // Edge case: Run is created in offline mode and also deleted in offline mode!
        // In that case we dont need to sync anything
    ...
    override suspend fun logout(): EmptyResult<DataError.Network> {
        ...
        client.plugin(Auth).providers.filterIsInstance<BearerAuthProvider>() // remote the user token
            .firstOrNull()
            ?.clearToken()
